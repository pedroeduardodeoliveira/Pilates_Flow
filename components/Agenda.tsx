        ...
        <div className="grid grid-cols-[48px_repeat(7,1fr)] min-w-[888px] relative">
          ...
          {weekDays.map((day, idx) => (
            <div 
              ...
              className={`sticky top-0 z-30 p-2 border-b border-slate-200 dark:border-gray-800 text-center flex flex-col items-center justify-center transition-all cursor-pointer hover:bg-sky-500/5 bg-slate-50 dark:bg-gray-900`}
            >
