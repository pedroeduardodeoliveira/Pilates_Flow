...
export const mockStudentsData: Student[] = [
    { id: 'AL-1092', name: 'Maria Oliveira', initials: 'MO', status: 'Ativo', level: 'Intermediário', expiryDate: '23/12/2025', daysToExpiry: 5, schedule: ['Seg - 08:00', 'Qua - 08:00'], instructor: 'Ana Silva', phone: '(11) 98765-4321', birthDate: '2000-12-10', planType: '2x na semana' },
    ...
    { id: 'AL-9912', name: 'Fernanda Costa', initials: 'FC', status: 'Ativo', level: 'Avançado', expiryDate: '13/12/2025', daysToExpiry: -5, isExpired: true, schedule: ['Seg - 07:00', 'Qua - 07:00', 'Sex - 07:00'], instructor: 'Carla Dias', phone: '(11) 97777-6666', planType: '3x na semana' },
...
export const mockInstructorsData: Instructor[] = [
    { id: '1', name: 'Ana Silva', initials: 'AS', studentsCount: 0, phone: '(11) 91111-1111', specialties: 'Fisioterapia, Pilates Clássico', avatarColor: 'bg-rose-600', workingDays: ['Seg', 'Qua', 'Sex'], workStart: '07:00', workEnd: '12:00', classDuration: 50 },
    { id: '2', name: 'Bruno Santos', initials: 'BS', studentsCount: 0, phone: '(11) 92222-2222', specialties: 'Ed. Física, Pilates Contemporâneo', avatarColor: 'bg-blue-600', workingDays: ['Ter', 'Qui'], workStart: '08:00', workEnd: '21:00', classDuration: 60 },
    { id: '3', name: 'Carla Dias', initials: 'CD', studentsCount: 0, phone: '(11) 93333-3333', specialties: 'Fisioterapia', avatarColor: 'bg-orange-500', workingDays: ['Seg', 'Qua'], workStart: '14:00', workEnd: '20:00', classDuration: 50 },
    { id: '4', name: 'Daniel Oliveira', initials: 'DO', studentsCount: 0, phone: '(11) 94444-4444', specialties: 'Ed. Física', avatarColor: 'bg-emerald-600', workingDays: ['Seg', 'Ter', 'Qua', 'Qui', 'Sex'], workStart: '07:00', workEnd: '21:00', classDuration: 50 }
];
